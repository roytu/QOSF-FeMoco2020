...
class QMolecule:
    ...
    def twoe_to_spin(mohijkl, mohijkl_bb=None, mohijkl_ba=None, threshold=1E-12):
        ...
        """
        # ROY INJECT
        d = QMolecule.twoe_to_spin_fast(mohijkl, mohijkl_bb, mohijkl_ba, threshold=1E-12)  # ROY MODIFIED
        return d
        ...
        #                if (p, q, r, s) in d:
        #                    moh2_qubit[(p, q, r, s)] = d[(p, q, r, s)]
        #                else:
        #                    moh2_qubit[(p, q, r, s)] = 0
        #return moh2_qubit
        # ROY INJECT
    ...
    @staticmethod
    def twoe_to_spin_fast(mohijkl, mohijkl_bb=None, mohijkl_ba=None, threshold=1E-12):
        ints_aa = numpy.einsum('ijkl->ljik', mohijkl)
